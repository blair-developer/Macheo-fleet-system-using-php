...
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,timeOut,program,area,mileage,purpose,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:timeOut,:program,:area,:mileage,:purpose,:status)";
...
if($lastInsertId)
{
echo "<script>alert('Booking successfull, Thanks');</script>";
...
echo "<script>alert('Something went wrong. Please try again');</script>";
 ...
 echo "<script>alert('vehicle already booked for these days, book again kindly with different days');</script>"; 
 echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
}
...
<title>MacheoVMS | Vehicle Details</title>
<!--Bootstrap -->
          ...
          <form method="post">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="time" class="form-control" name="timeOut" value="<?php echo date("H:i:s")?>" onchange="showUser(this.value)" required/>
              </div>
                       
            <div class="form-group">
              <label>Intervention/Program:</label>
              <select name="program" class="form-control" required >
                        <option value selected ></option>
                            <option value="Macheo home">Mch</option>
                            <option value="school-feeding">School-Feeding</option>
                            <option value="education & skills">Edu&skills</option>
                            <option value="Administration">Admin</option>
                            <option value="HfN-dept">HFN department</option>
                            <option value="Other department">Other Departments</option>
              </select>
            </div>
            <?php

                $area = array("Area A", "Area B", "Area C", "Area D", "Area E", "Area F", "Area X");
            ...
            <div class="form-group">
              <label>Mileage In/Out:</label>
              <input type="text" class="form-control" name="mileage" placeholder="Mileage in KM" required>
            </div>
              
            <div class="form-group">
              <label>Purpose of trip:</label>
              <textarea rows="4" class="form-control" name="purpose" placeholder="purpose/Specific loation name for the trip" required></textarea>
            </div>
