    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/apple-touch-icon-57-precomposed.png" alt="image"/></a> </div>
        </div>
          ...
          ?>-->
           ...
           <!-- <div class="header_widgets">
            ...
            <div class="header_widgets">
              ...
              <p class="uppercase_text">HelpLine<br><span class="text-primary">0726720085</span> </p>
